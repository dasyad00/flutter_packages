...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  /// Returns the minimum exposure duration supported by the camera in seconds.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation."
                                                   @"CameraApi.getMinExposureDuration",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMinExposureDuration:)],
                @"FCPCameraApi api (%@) doesn't respond to @selector(getMinExposureDuration:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMinExposureDuration:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns the maximum exposure duration supported by the camera in seconds.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation."
                                                   @"CameraApi.getMaxExposureDuration",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMaxExposureDuration:)],
                @"FCPCameraApi api (%@) doesn't respond to @selector(getMaxExposureDuration:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
  ...
  /// Returns the minimum exposure ISO supported by the camera.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation."
                                                   @"CameraApi.getMinExposureISO",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMinExposureISO:)],
                @"FCPCameraApi api (%@) doesn't respond to @selector(getMinExposureISO:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMinExposureISO:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns the maximum exposure ISO supported by the camera.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation."
                                                   @"CameraApi.getMaxExposureISO",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMaxExposureISO:)],
                @"FCPCameraApi api (%@) doesn't respond to @selector(getMaxExposureISO:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMaxExposureISO:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
